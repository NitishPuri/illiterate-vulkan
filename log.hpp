...
App::initVulkan {
  ...
  App::createVertexBuffer {
    ...
    App::createBuffer {
      ...
      [VALIDATION ERROR] validation layer:  Validation Error: [ VUID-vkGetBufferMemoryRequirements-buffer-parameter ] Object 0: handle = 0x20fb96e5060, type = VK_OBJECT_TYPE_INSTANCE; | MessageID = 0x8001e81c | vkGetBufferMemoryRequirements(): buffer Invalid VkBuffer Object 0xcccccccccccccccc.
